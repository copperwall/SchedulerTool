...
public class Instructor extends User {
   ...
   /*@
       ensures
       // Instructor has all fields defined
       firstName.equals(first) && lastName.equals(last) && workTimeUnits == wtu &&
       username.equals(userID) && isActive == active;
    @*/
   public Instructor(String first, String last, String userID, int wtu, boolean isActive) {
   ...
   /*@
      ensures
      // the name returned is the name of the instructor
      \result.equals(name);
    @*/
    ...
    */
   /*@
      // return value is the name property
    ...
    */
   /*@
      //Ensures the return value is the work time units
      ensures \result == wtu;
    @*/
   public int getWtu() {
    ...
    */
   /*@
       // Ensures that the username is returned
       ensures \result.equals(user); 
    @*/
